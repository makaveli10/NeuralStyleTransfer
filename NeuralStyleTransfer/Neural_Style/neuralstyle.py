...
from utilities import preprocess_image, deprocess_image
from compute_loss import style_reconstruction_loss, feature_content_loss, variation_loss
...
class Neural_Styler(object):
    ...
    def __init__(self,
        ...
        for layer in self.style_layers:
            ...
            temp_style_loss += weight * style_reconstruction_loss(style_image_features,
        ...
        tv_loss = self.tv_weight * variation_loss(self.output_img,
                                                  self.img_nrows,
                                                  self.img_ncols)
